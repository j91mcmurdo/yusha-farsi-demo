...
### 3. Poor Farsi Audio Quality

**Symptom:** The Farsi audio generated by ElevenLabs sounds unnatural or incorrect.

**Explanation:** As of July 2025, the currently available ElevenLabs models (v2) do not have official, high-quality support for the Farsi language. The audio you hear is a "best effort" attempt by the model. The new v3 models, which are currently in alpha, have native Farsi support and offer a significant improvement in quality. This repository will be updated to use the v3 models as soon as they are publicly available.
